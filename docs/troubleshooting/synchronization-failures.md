...
| `QueueFull` | One scope reached the 2,048 pending-change or pending-command limit | Restore delivery and drain retained work; do not raise the bound or clear SQLite | New work is accepted after the pending count falls below the limit |
