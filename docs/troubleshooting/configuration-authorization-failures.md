...
| `eitmad.error.config-unavailable.v1` | Storage/schema/read failure | Stop mutations, run diagnostics, preserve the runtime directory, and escalate with sanitized health/error IDs |
