...
- [Upgrade to protocol 1.9 and storage version 12 customers](storage-v12-customers.md): branch-scoped customer contacts, normalized search, atomic local-first state, generated bindings, and rollback limits.
