...
| الأثاث | Furniture | The manager-facing product collection in the Windows preview. Its compact table and three-step editor are transient fixtures; no Furniture lifecycle is durable or Rust-authoritative yet. |
