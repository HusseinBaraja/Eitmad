        ...
        [
            new(
                ...
                [
                    ...
                    new("مكتب عمل", "بثلاثة أدراج", "140 × 75 × 65 سم", "جوزي", "مقبض نحاسي", 1, FurnitureIllustration.Table),
                ],
                [
                    new("جانب الخزانة الكبيرة", 2),
                    new("باب الخزانة الكبيرة", 4),
                    new("رف الخزانة الكبيرة", 5),
                    new("قاعدة الخزانة الكبيرة", 1),
                    new("سطح مكتب العمل", 1),
                    new("رجل مكتب العمل", 2),
                    new("واجهة درج المكتب", 3),
                ],
                "يُرجى مطابقة اتجاه عروق الخشب بين أبواب الخزانة وسطح المكتب. يفضّل العميل أن تكون جميع المقابض على ارتفاع واحد."),
            new(
