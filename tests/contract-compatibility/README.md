...
The canonical Rust fixture is `fixtures/protocol-v1.json`. The C# runner compiles on .NET 8; the Swift runner compiles on macOS CI. Regenerate or check every output through `crates/contracts/codegen`; never edit generated bindings directly.
