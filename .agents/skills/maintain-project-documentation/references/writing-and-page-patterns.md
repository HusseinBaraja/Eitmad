...
- Write instructions in clear English while quoting the exact Arabic labels visible in the UI and using approved Arabic furniture terminology where the workflow depends on it.
